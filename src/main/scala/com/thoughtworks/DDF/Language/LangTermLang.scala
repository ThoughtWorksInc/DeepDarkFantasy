...
trait LangTermLang extends Lang[LangInfoG, LangTerm] with IsoLang[InterLangInfoG, LangInfoG, InterLangTerm, LangTerm] {
  override val infoIso = new (InterLangInfoG <~> LangInfoG) {
    ...
    override val from = new NaturalTransformation[LangInfoG, InterLangInfoG] {
  ...
  override val reprIso = new (InterLangTerm <~> LangTerm) {
    override val to = new NaturalTransformation[InterLangTerm, LangTerm] {
    ...
    override val from = new NaturalTransformation[LangTerm, InterLangTerm] {
