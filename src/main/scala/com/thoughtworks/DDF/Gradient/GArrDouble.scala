...
trait GArrDouble extends Gradient[Double => Double] {
  ...
  override def plus: LangTerm[((Double, (Double) => Double)) => ((Double, (Double) => Double)) => (Double, (Double) => Double)] = ???

  override def mult: LangTerm[((Double, (Double) => Double)) => ((Double, (Double) => Double)) => (Double, (Double) => Double)] = ???

  override def div: LangTerm[((Double, (Double) => Double)) => ((Double, (Double) => Double)) => (Double, (Double) => Double)] = ???
