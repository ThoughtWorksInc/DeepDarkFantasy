...
A: I am trying to complete the formalization of a core subset of the language, to demonstrate what does derivative in our context mean (and why it is correct).
# Thank You Sir
